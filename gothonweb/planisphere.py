...
"""
The Gothons of Planet Percal #25have invaded your ship and destroyed 
your entire crew. You are the last survining member and your last 
...
nebhaq gur ubhrf, fur fvgf nebhaq gur ubhrf. The Gothon stops, tries 
...
"""
The container licks open and the seal breaks, letting gas out. You 
grab the neutron bomb and run as fast as you can to the bridge where you 
must place it in the right spot.

You burst on to the Bridge with the neutron bomb under your arm 
...
pulled their weapons out yet, as they see the active bomb under you arm 
...
bomb is placed you run to the escape pod to gget off this tin can.
...
def name_room(room):
	...
	What's a better solution that this global looup?
	"""
